...
import { gate_buffterFly_spine } from '../../gate/script/gate_buffterFly_spine';
const { ccclass, property } = _decorator;
enum BlockType {
    BT_NONE,
    BT_STONE,
};
@ccclass('df1_init_frepab_buffterfly')
export class df1_init_frepab_buffterfly extends Component {
    @property(Node)
    private emitform_df1_manager: Node = null;
    @property(Prefab)
    ...
    start() {
        ...
        this.emitform_df1_manager.on('moving_position_buffter_fly_list', this.get_bufferfly_position_list, this);
    ...
    init_prefab() {
        ...
        for (let j = 0; j <= this.arrayNodeLenth + 1; j++) {
            ...
            if (block) {
                ...
                buffter_fly_moving.emitfom_gate_main = this.emitform_df1_manager;
